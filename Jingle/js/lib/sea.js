...
var rootUrl = window.location.href.substring(0,window.location.href.lastIndexOf("www")+3);
//这里路径是按照html页面的相对路径为准
seajs.use("./js/app/configuration.js",function(configuration){
	  seajs.config({
